        ...
        onPressed: () async {
          ...
          if (appProvider.checkNull()) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: const Text('برجاء اختيار مواعيد حضور وانصراف الموظف'),
          ...
          final List<int> offDays = List<int>.from(appProvider.offDaysGetter());
          ...
          if (appProvider.checkIFAllowedDelayTimeIsZero()) {
            ...
            await Alert(
              context: context,
              title: 'تحذير',
              desc: 'هل انت متأكد من عدم اعطاء الموظف اي وقت مسموح للتأخير',
              type: AlertType.warning,
              style: AlertStyle(
          ...
          appProvider.workingFromString = appProvider.correctWorkingTimesToIso(
          ...
          final employeeData = await AddNewEmployeeUseCase().addNewEmployeeData(
